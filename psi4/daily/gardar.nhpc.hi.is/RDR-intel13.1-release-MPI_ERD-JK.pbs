...
export build_name=RDR-intel13.1-release-MPI_ERD-JK
...
./setup --fc=mpif90 --cc=mpicc --cxx=mpiCC --mpi --plugins=on --python=$PYTHON --type=release -DENABLE_CHEMPS2=OFF --erd --jkfactory -D BUILDNAME=${build_name} -D SITE=${site_name}
