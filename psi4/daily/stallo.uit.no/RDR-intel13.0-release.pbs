...
export build_name=RDR-intel13.0-release
...
TMP_DIR=/global/work/roberto/tmprunpsi4/RDR-intel13.0-release
mkdir -p $TMP_DIR
...
./setup --fc=ifort --cc=icc --cxx=icpc --type=release --plugins=on --python=$PYTHON -D BUILDNAME=${build_name} -D SITE=${site_name}
